...
PVR_ERROR GetTimerTypes ( PVR_TIMER_TYPE types[], int *size )
{
  ...
  */
  ...
  types[0].iId = 1;
  types[0].iAttributes = TIMER_MANUAL_ATTRIBS;
  strncpy(types[0].strDescription, "TIMER_MANUAL_ATTRIBS",PVR_ADDON_TIMERTYPE_STRING_LENGTH);
  types[1].iId = 2;
  types[1].iAttributes , TIMER_EPG_ATTRIBS;
  strncpy(types[1].strDescription , "TIMER_EPG_ATTRIBS",PVR_ADDON_TIMERTYPE_STRING_LENGTH);
  types[2].iId = 3;
  types[2].iAttributes = TIMER_REPEATING_MANUAL_ATTRIBS;
  strncpy(types[2].strDescription , "TIMER_REPEATING_MANUAL_ATTRIBS",PVR_ADDON_TIMERTYPE_STRING_LENGTH);
  types[3].iId = 4;
  types[3].iAttributes = TIMER_REPEATING_EPG_ATTRIBS;
  strncpy(types[3].strDescription , "TIMER_REPEATING_EPG_ATTRIBS",PVR_ADDON_TIMERTYPE_STRING_LENGTH);
  types[4].iId = 5;
  types[4].iAttributes = TIMER_CHILD_ATTRIBUTES;
  strncpy(types[4].strDescription , "TIMER_CHILD_ATTRIBUTES",PVR_ADDON_TIMERTYPE_STRING_LENGTH);
  types[5].iId = 6;
  types[5].iAttributes = TIMER_KEYWORD_ATTRIBS;
  strncpy(types[5].strDescription , "TIMER_KEYWORD_ATTRIBS",PVR_ADDON_TIMERTYPE_STRING_LENGTH);
  types[6].iId = 7;
  types[6].iAttributes = TIMER_REPEATING_KEYWORD_ATTRIBS;
  strncpy(types[6].strDescription , "TIMER_REPEATING_KEYWORD_ATTRIBS",PVR_ADDON_TIMERTYPE_STRING_LENGTH);
  *size = 7;
